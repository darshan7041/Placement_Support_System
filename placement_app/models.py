...
class Cource(models.Model):
    cource_id = models.AutoField(primary_key=True)
    cource_name = models.CharField(max_length=30, blank=True, null=True)
...
class Department(models.Model):
    ...
    cource = models.ForeignKey(Cource, models.DO_NOTHING, blank=True, null=True)
...
class PlacementDetails(models.Model):
    ...
    pd_position = models.CharField(max_length=40, blank=True, null=True)
    pd_qualification = models.CharField(max_length=50, blank=True, null=True)
    pd_salary_or_package = models.IntegerField(blank=True, null=True)
    pd_required_people = models.IntegerField(blank=True, null=True)
    pd_status = models.CharField(max_length=50, blank=True, null=True)
...
class Student(models.Model):
    ...
    s_f_name = models.CharField(max_length=10)
    s_m_name = models.CharField(max_length=10)
    s_l_name = models.CharField(max_length=10)
    s_enrollment_number = models.IntegerField()
    s_phone_number = models.IntegerField()
    s_aadhar_card = models.IntegerField()
    s_guardian_mobile_number = models.IntegerField()
    s_guardian_email = models.CharField(max_length=40)
    ...
    s_cource = models.CharField(max_length=30)
